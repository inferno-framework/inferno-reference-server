...
window.mitre.fhirreferenceserver.authorize = {
    ...
    init : function()
    {
        ...
        let base_url = window.mitre.fhirreferenceserver.utils.getBaseURL('authorization');
        const url = base_url + 'authorizeClientId/' + clientId; //will be oauth/authorizeClientId
